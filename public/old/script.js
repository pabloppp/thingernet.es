<!-- sortable portfolio & popup -->	
$(window).load(function(){
 
$("a[data-fancybox-group=portfoliogallery]").fancybox({
      ...
      var $container = $('.portoliosortable');
...
jQuery(function($){
        $("#twitter").tweet({
           join_text: "auto",
          username: "thethingernet", //replace this with your username
		  modpath: './twitter/',
          avatar_size: 32,
          count: 2,
...
<!-- Flickerfeed -->	
 $('#cbox').jflickrfeed({
	limit: 9,
	qstrings: {
		id: '123926831@N05' //replace this with your ID
	},
	itemTemplate:
	'<li>' +
...
<!-- google map -->		
$("#contactmap").gMap({
	address: "Alicante, Comunidad Valenciana, España",//replace this with your address
	zoom: 10,
	markers:[
		{
			latitude: 38.3459963, //replace this with your latitude
			longitude: -0.4906855000000405,//replace this with your longitude
